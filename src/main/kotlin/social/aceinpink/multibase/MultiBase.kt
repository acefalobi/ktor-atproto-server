package social.aceinpink.multibase

import social.aceinpink.multibase.MultiBase.Base.*
...
object MultiBase {
    ...
    fun encode(base: Base, data: ByteArray): String {
        return when (base) {
            ...
            BASE32_PAD -> base.prefix + Base32().encodeToString(data).lowercase()
            ...
            BASE32_HEX_PAD -> base.prefix + Base32(true).encodeToString(data).lowercase()
